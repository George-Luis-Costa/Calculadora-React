...
//     clearMemory() {
//         console.log('Limpar')    //ver o que está acontecendo no console do browser
//     }

//     setOperation(operation) {
//         console.log(operation)   //ver o que está acontecendo no console do browser
//     }

//     addDigit(n) {
//         console.log(n)           //ver o que está acontecendo no console do browser
//     }

//     render() {
//         //Garante o componente pelo "this" correto, a qual, eu desejo associar
//                     // recebe valor (n)       //envia o valor (n)
//         // const addDigit = n => this.addDigit(n)
//         // const this.setOperation = op => this.setOperation(op)

//         return (
//             <div className="calculator"> {/* Como isso é JSX, nao podemos usar a palavra reservada "class" do JS, entao resolvemos isso com "className" */}
...
export default class Calculator extends Component {
    ...
    //Referenciando o this de forma correta pelo metodo bind(), poderia ser feito com arrow function, como exemplo anterior no material
    constructor(props) {
        super(props)
        this.clearMemory = this.clearMemory.bind(this)
        this.setOperation = this.setOperation.bind(this)
    ...
    setOperation(operation) { // Uma OBS: Ao setar operacao devemos manipular o array "values" no indice 1, pois o indice 0 ja terá algo inserido -> values: [0, 0]
        if (this.state.current === 0) {  //verificando se o indice está no 0 
            ...
            const currentOperation = this.state.operation // input-operacao-input, armazena-se isso em currentOperation. ao invez de =, o user usa outro operador como +,-,*,/
    ...
    addDigit(n) {
        ...
        // // (Se receber o digito que é um ponto) && (ja ter no display um ponto), logo nao posso aceitar esse cenario, entao, inserimos um retorno vazio
        ...
        const currentValue = clearDisplay ? ' ' : this.state.displayValue  // Condiçao, depende se o display vai ser limpo ou nao. Se for limpo recebe " "(vazio), caso contrario recebe "this.state.displayValue" valor atual que está no display
        const displayValue = currentValue + n // Recebe currentValue + n, em que n é o valor digitado
        this.setState({ displayValue, clearDisplay: false }) // passando para o State o "displayValue" e o " clearDisplay: false", pois foi digitado algo, entao por isso "false"
    ...
    render() {
        //Garante o componente pelo "this" correto, a qual, eu desejo associar. Isso é o equivalente a forma que foi feita pelo contructor com bind()
        // recebe valor (n)       //envia o valor (n)
        // const addDigit = n => this.addDigit(n)
        // const this.setOperation = op => this.setOperation(op)
        ...
        return (
            <div className="calculator"> {/* Como isso é JSX, nao podemos usar a palavra reservada "class" do JS, entao resolvemos isso com "className" */}
                ...
                {/* Display para exibir */}
                <Display value={this.state.displayValue} /> {/* Agora referencia o displayValue do State  */}
